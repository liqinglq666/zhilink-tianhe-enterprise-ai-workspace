...
from zhilian_tianhe_agent.llm_client import LLMConfig, public_model_available
...
def test_frontend_exposes_public_mode_without_embedding_secret() -> None:
    source = open("frontend/assets/ui-redesign-live-fixes.js", encoding="utf-8").read()
    assert "比赛公共模型已支持" in source
