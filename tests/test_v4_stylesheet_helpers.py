...
STATIC_STYLES = (
    *STATIC_PRESENTATION_LAYERS.values(),
    ("ui-v4-workspace.css", "data-ui-v4-workspace"),
)
...
def test_index_is_the_single_v4_stylesheet_owner() -> None:
    ...
    for stylesheet, marker in STATIC_STYLES:
...
def test_v4_presentation_layers_do_not_load_stylesheets_from_javascript() -> None:
    for filename, (stylesheet, _) in STATIC_PRESENTATION_LAYERS.items():
